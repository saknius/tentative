#include <iostream>
using namespace std;
you start to read the code and the first thingh you notice is there are two variables iniitializes n and w and than two fixes sized arrays val[n] and w[n]
now applying basic idea knapsack was about if we have n weights and we want to achieve final weight sum w how do we add them that is in
what order
